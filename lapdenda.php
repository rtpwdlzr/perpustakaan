...
<html lang="en">
  <head>
    ...
    <title>Sirkulasi Perpustakaan - Cetak Informasi Denda</title>
    ...
    <script>
        function table_load(){
            url="laporan/denda/data_alldisplay.php?table=denda"
            $("#table_area").load(url);
            }
        ...
        function check(){
            bulan=$("#bulan").val();
            tahun=$("#tahun").val();
            url="laporan/denda/data_filterdisplay.php?table=denda&bulan="+bulan+"&tahun="+tahun;
            $("#table_area").load(url);
            }
                ...
                <p class="centered"><a><img src="assets/img/logowahasa.png" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="lapdenda.php">Cetak Informasi Denda</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            	<h3><i class="fa fa-angle-right"></i> Laporan / Cetak Informasi Denda </h3>
              <div class="row mt">
                <div class="col-lg-12">
              ...
              <div class="row mt">
            		<div class="col-lg-12">
            			<div class="form-panel">
                    	  <h4 class="mb"><i class="fa fa-angle-right"></i> Preview Table Cetak Informasi Denda</h4>
                        <form class="form-inline" role="form">
  ...
  <script>
      ...
      function print_docall(){
         window.open("laporan/denda/printall.php","_blank");
       }
       function print_docfilter(){
          bulan=$("#bulan").val();
          tahun=$("#tahun").val();
          window.open("laporan/denda/printfilter.php?bulan="+bulan+"&tahun="+tahun,"_blank");
        }
      $(function(){
