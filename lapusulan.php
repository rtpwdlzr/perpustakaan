...
<html lang="en">
  <head>
    ...
    <title>Sirkulasi Perpustakaan - Cetak Usulan Buku</title>
    ...
    <script>
        function table_load(){
            url="laporan/usulan/data_alldisplay.php?table=usulan"
            $("#table_area").load(url);
            }
        ...
        function check(){
    				bulan=$("#bulan").val();
            tahun=$("#tahun").val();
            url="laporan/usulan/data_filterdisplay.php?table=usulanfilter&bulan="+bulan+"&tahun="+tahun;
    				$("#table_area").load(url);
    			  }
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <p class="centered"><a><img src="assets/img/logowahasa.png" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="lapusulan.php">Cetak Usulan Buku</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            	<h3><i class="fa fa-angle-right"></i> Laporan / Cetak Usulan Buku </h3>
              <div class="row mt">
                <div class="col-lg-12">
                  <div class="form-panel">
                        ...
                        <form class="form-inline" role="form">
                            ...
                            <div class="form-group">
                              <label>Tahun</label>
                              <input type="text" class="form-control bfh-number" value="2010" data-min="1800" data-max="<?php echo date('Y');?>" id="tahun">
                            </div>
              ...
              <div class="row mt">
            		<div class="col-lg-12">
            			<div class="form-panel">
                    	  <h4 class="mb"><i class="fa fa-angle-right"></i> Preview Table Cetak Usulan Buku</h4>
                        <form class="form-inline" role="form">
      ...
      <footer class="site-footer">
          <div class="text-center">
              Kembali ke atas
              <a href="lapusulan.php#" class="go-top">
  ...
  <script>
      ...
      function print_docall(){
         window.open("laporan/usulan/printall.php","_blank");
       }
       function print_docfilter(){
          bulan=$("#bulan").val();
          tahun=$("#tahun").val();
          window.open("laporan/usulan/printfilter.php?bulan="+bulan+"&tahun="+tahun,"_blank");
        }
      $(function(){
