...
<html lang="en">
  <head>
    ...
    <title>Sirkulasi Perpustakaan - Cetak Sirkulasi Buku</title>
    ...
    <script>
        function table_load(){
            url="laporan/sirkulasi/data_alldisplay.php?table=sirkulasi"
            $("#table_area").load(url);
            }
        function check(){
            bulan=$("#bulan").val();
            tahun=$("#tahun").val();
            url="laporan/sirkulasi/data_filterdisplay.php?table=sirkulasi&bulan="+bulan+"&tahun="+tahun;
            $("#table_area").load(url);
            }
                ...
                <p class="centered"><a><img src="assets/img/logowahasa.png" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="lapsirkulasi.php">Cetak Sirkulasi Buku</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            	<h3><i class="fa fa-angle-right"></i> Laporan / Cetak Sirkulasi Buku </h3>
              <div class="row mt">
                <div class="col-lg-12">
                  <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> Pengaturan Filter Tampilan Laporan Berdasarkan Tanggal Pinjam</h4>
              ...
              <div class="row mt">
            		<div class="col-lg-12">
            			<div class="form-panel">
                    	  <h4 class="mb"><i class="fa fa-angle-right"></i> Preview Table Cetak Sirkulasi Buku</h4>
                        <form class="form-inline" role="form">
  ...
  <script>
      ...
      function print_docall(){
         window.open("laporan/sirkulasi/printall.php","_blank");
       }
       function print_docfilter(){
          bulan=$("#bulan").val();
          tahun=$("#tahun").val();
          window.open("laporan/sirkulasi/printfilter.php?bulan="+bulan+"&tahun="+tahun,"_blank");
        }
        $(function(){
